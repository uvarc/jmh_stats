...
## CRAN packages
RUN R -e "install.packages(c('shiny','shinythemes','shinybusy','dplyr','readxl','ggplot2','gridExtra','readxl','shinyWidgets'))"
...
# Get the app code
RUN git clone https://github.com/uvarc/jmh_stats.git
RUN cp -r jmh_stats/* /srv/shiny-server/
